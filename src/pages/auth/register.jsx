...
import {
	googleSign,
	registerUser,
} from '../../helper/context/action/authActions';
		...
		<main className="auth-container">
			<div className="main-container">
				...
				<form
					...
					onSubmit={
						handleSubmit(createUserWithEmailAndPasswordHandler)
					}
				>
					{authError ? (
            ...
            Already have an account? &nbsp;
                  ...
                  `}
						...
						{/* <div className="form-group ">
                            ...
                            {errors?.dateOfBirth ?
                              <span className="form-group__error-msg">
                              {errors?.dateOfBirth.message}</span>: null}
                        </div> */}
						<div className="form-group">
							<div className="form-input">
								<input
