        ...
        <main>
            <div className={style.homeContainer}>
                ...
                <div className={style.contentContainer}>
                    ...
                    <p>At M-Pack, we give you the best when it comes to Ecommerce, Weather forecast, News and so much more. </p>
            ...
            <section id="pack" className="main-container">
                <div className={style.packGrid}>
                    <ProductCard 
                        srcset={`${ecommerce1} 310w,${ecommerce2} 684w,${ecommerce} 730w`}
                        src={ecommerce}
                        to="/ecommerce/shop"
                        title="Ecommerce"
                    />
